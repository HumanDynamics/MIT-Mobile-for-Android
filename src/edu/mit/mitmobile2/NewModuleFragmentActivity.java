...
public abstract class NewModuleFragmentActivity extends FragmentActivity {
	...
	private void initViews() {
		mTitleBar.setOnTitleBarListener(new OnMITTitleBarListener() {
			...
			public void onOptionItemSelected(String optionId) {
				if (!getNewModule().onItemSelected(NewModuleFragmentActivity.this, optionId)) {
			...
			public void onHomeSelected() {
				HomeScreenActivity.goHome(NewModuleFragmentActivity.this);				
			}

			@Override
			public void onModuleHomeSelected() {
				Intent intent = new Intent(NewModuleFragmentActivity.this, getNewModule().getModuleHomeActivity());
